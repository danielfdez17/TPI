...
public class GamePrinter {
	...
	protected String getInfo() {
		...
		/* @formatter:off */
		buffer.append(NEW_LINE).append(Messages.NUMBER_OF_CYCLES + " " + game.getCycle());
		buffer.append(NEW_LINE).append(Messages.NUMBER_OF_COINS + " " + game.getSuncoins());
		buffer.append(NEW_LINE).append(Messages.REMAINING_ZOMBIES + " " + game.getRemainingZombies());
		buffer.append(NEW_LINE).append(Messages.GENERATED_SUNS + " " + game.getGeneratedSuns());
		buffer.append(NEW_LINE).append(Messages.CAUGHT_SUNS + " " + game.getCaughtSuns());
		buffer.append(NEW_LINE).append(Messages.SCORE + " " + game.getScore());
...
//		System.out.println(Messages.GENERATED_SUNS + " " + game.getGeneratedSuns());
//		System.out.println(Messages.CAUGHT_SUNS + " " + game.getCaughtSuns());
		/* @formatter:on */
